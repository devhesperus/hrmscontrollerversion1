...
namespace HRMSAPPLICATION.Controllers
{
    ...
    public class PaymBranchesController : ControllerBase
    {
        ...
        // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
        [HttpPost]
        public async Task<ActionResult<PaymBranch>> PostPaymBranch(PaymBranch paymBranch)
        {
            ...
            return CreatedAtAction("GetPaymBranch", new { id = paymBranch.PnCompanyId }, paymBranch);
        }
