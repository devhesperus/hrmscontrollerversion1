...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__attendan__3214EC07DE7E151A");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__daily_ti__3214EC07BB65707A");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__form7__3214EC07DEF9FED3");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__hr_authe__3214EC07EE71E5A3");
        ...
        {
            entity.HasKey(e => e.Sno).HasName("PK__leave_ap__CA1FE46499F10415");

            entity.ToTable("leave_apply");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__leaveall__3214EC07360BD7D3");
        ...
        {
            entity.HasKey(e => e.Sno).HasName("PK__leaveapp__DDDF6446E3A7C5EE");
        ...
        {
            entity.HasKey(e => e.Sno).HasName("PK__leaveapp__DDDF6446511665F9");
        ...
        {
            entity.HasKey(e => e.LoanReqno).HasName("PK__loan_pos__E62AF50BDBD7646B");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__PayProce__3213E83FC472AEE4");
        ...
        {
            entity.HasKey(e => e.AttbonusId).HasName("PK__paym_att__E9729F0555FBDFC9");

            entity.ToTable("paym_attbonus");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__paym_Car__3213E83F1F0EFDD2");
        ...
        {
            entity.HasKey(e => e.PnCompanyId).HasName("PK__paym_Com__71C96404786F7091");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__paym_Emp__3213E83F5E1B9658");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__paym_emp__3214EC07DDF985BB");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__paym_Enc__3213E83F9718C980");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__paym_hol__3213E83F45F48AD6");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__paym_loa__3213E83FA042D47A");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__paym_pay__3213E83FF826E0FF");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Paym_vpf__3213E83FC7185F7A");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__payoutpu__3213E83F577FF19A");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__PF_EPS__3214EC078DF4B8AF");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__PF_EPF__3214EC07FC8C7AEE");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__punch_de__3213E83F101E61E0");
        ...
        {
            entity.HasKey(e => new { e.FromDate, e.ToDate }).HasName("PK__salary_p__72A39BB50B45A32E");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__salary_s__3214EC07C21827C0");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__shift_ba__3214EC070C9F2EDE");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__shift_mo__3214EC07688A057D");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__temp_ded__3214EC07D50C8A17");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__temp_ear__3214EC0762C16C6F");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Temp_Emp__3214EC07475D2BBA");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Temp_Mus__3214EC07E8CED533");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__temp_net__3214EC070A11EFE3");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__temp_Pay__3214EC0715A4AD25");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__temp_tim__3214EC07C1A9F005");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__tempsatt__3214EC0772182C63");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__tempshif__3214EC0740383DFE");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__tempshif__3214EC072FB274CE");
        ...
        {
            entity.HasKey(e => e.Sno).HasName("PK__time_car__CA1FE464CF871507");
